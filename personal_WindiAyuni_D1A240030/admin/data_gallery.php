    ...
    <div class="flex max-w-7xl mx-auto mt-8 px-4">
        ...
        <aside class="w-1/4 bg-white rounded shadow p-4">
            ...
            <ul class="space-y-2 text-gray-700">
                <li><a href="beranda_admin.php" class="block hover:text-green-600">Beranda</a></li>
                <li><a href="data_artikel.php" class="block hover:text-green-600">Kelola Artikel</a></li>
                <li><a href="data_gallery.php" class="block font-semibold text-green-800">Kelola Gallery</a></li>
                <li><a href="about.php" class="block hover:text-green-600">About</a></li>
                <li>
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold text-pink-600">Daftar Gallery</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    echo "<div class='p-4'>";
                    echo "<p class='font-semibold text-pink-600 mb-2'>" . htmlspecialchars($data['judul']) . "</p>";
