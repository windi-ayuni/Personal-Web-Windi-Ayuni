...
600">Beranda</a></li>
            ...
            <li><a href="data_artikel.php" class="block hover:text-green-600">Kelola
                    Artikel</a></li>
            <li><a href="data_gallery.php" class="block hover:text-green-600">Kelola
                    Gallery</a></li>
...
tbl_gallery"));
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="text-lg text-gray-800 mb-4">
                Halo, <strong class="text-pink-500">
...
blue-600">
                    ...
                    <h3 class="text-xl font-semibold text-green-700">Artikel</h3>
