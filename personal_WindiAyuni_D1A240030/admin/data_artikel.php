...
medium">Logout</a>
        ...
        <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="add_artikel.php" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700
...
href='edit_artikel.php?id_artikel={$data['id_artikel']}' class='text-pink-
