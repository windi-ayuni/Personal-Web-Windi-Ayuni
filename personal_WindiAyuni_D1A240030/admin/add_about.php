...
focus:border-green-500"></textarea>
                ...
                <div class="flex justify-end space-x-4">
                    <button type="submit" class="bg-green-700 text-white px-4 py-2 rounded hover:bg-green-
800 transition">Simpan</button>

                    <a href="about.php" class="bg-green-300 text-green-700 px-4 py-2 rounded hover:bg-
green-400 transition">Batal</a>
