...
600">Beranda</a></li>
                ...
                <li><a href="data_artikel.php" class="block font-semibold text-green-
800">Kelola Artikel</a></li>

                <li><a href="data_gallery.php" class="block hover:text-green-
600">Kelola Gallery</a></li>

                <li><a href="about.php" class="block hover:text-green-
600">About</a></li>
...
gray-700 mb-1">Judul Artikel</label>
                    ...
                    <input type="text" id="nama_artikel" name="nama_artikel" required class="w-full p-2 border rounded focus:outline-none focus:ring
...
green-700 mb-1">Isi Artikel</label>
...
focus:border-pink-500"></textarea>
                ...
                <div class="flex justify-end space-x-4">
                    <button type="submit" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-
800 transition">Simpan</button>

                    <a href="data_artikel.php" class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-
